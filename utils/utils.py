...
def make_style_prompt(choices: list, default: str = None, main_style="none", frame_style="none", frame_border_style="none") -> str:
    """
    ...
    choice_index = Prompt.ask(Text.assemble(("╰>", main_style)), choices=[str(x) for x in range(1, c + 1)], default=default_index)
